...
public class ButtonGradient extends JButton {
    ...
    public int cBorderRadius = 10;

    public int getkBorderRadius() {
        int kBorderRadius;
        return cBorderRadius;
    }

    public void setkBorderRadius(int cBorderRadius) {
        this.cBorderRadius = cBorderRadius;
    }
    ...
    protected void paintComponent(Graphics grphcs) {
        ...
        g2.setPaint(gra);
        g2.fillRoundRect(0, 0, width, height, cBorderRadius, cBorderRadius);
        //  Add Style
        createStyle(g2);
        if (pressed) {
            paintPressed(g2);
